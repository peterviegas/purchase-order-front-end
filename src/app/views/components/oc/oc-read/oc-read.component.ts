...
@Component({
  selector: 'app-oc-read',
  templateUrl: './oc-read.component.html',
  styleUrls: ['./oc-read.component.css']
})
export class OcReadComponent implements AfterViewInit {
  ...
  navigateToCreate():void{
    this.router.navigate(['oc/create']);
  }
